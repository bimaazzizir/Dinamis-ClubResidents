...
<div class="sidebar"  style="opacity: 0.93; border-radius: 7px">
	...
	<a  style="background-color: #cccccc;" class="sidebar_link" href="data_reservasi_ballroom.php"><b>Data Reservasi BallRoom</b></a><br>
...
<div class="content">
<h3 class="title" style="opacity: 0.89; border-radius: 7px; font-size: 25px">DATA RESERVASI BALLROOM</h3>
...
<table border='1' cellpadding="2" cellspacing="0" width="100%" align="center">
	<tr bgcolor="#cccccc">
		...
		<th width="130px">Room</th>
		<th width="60px">Date</th>
		<th width="40px">Orang</th>
		<th width="45px">Opsi</th>
	</tr>
<?php
include "config.php";
$sql="SELECT `id_ballroom`, `nama_ballroom`, `identitas_ballroom`, `ruang_ballroom`, `tanggal_ballroom`, `orang_ballroom` FROM `reservasi_ballroom` ORDER BY id_ballroom";
...
?>
	<tr align="center" bgcolor="white">
		<td><?php echo $no;?></td>
		<td><?php echo $data['id_ballroom']; ?></td>
		<td><?php echo $data['nama_ballroom']; ?></td>
		<td><?php echo $data['identitas_ballroom']; ?></td>
		<td><?php echo $data['ruang_ballroom']?></td>
		<td><?php echo $data['tanggal_ballroom']?></td>
		<td><?php echo $data['orang_ballroom']?></td>
		<td>
			<a class="aa" href="#" onclick="return confirm('Mohon Maaf, Fitur ini masih dalam perbaikan');">Edit </a>|
			<a class="aa" href="hapus_reservasi_ballroom.php?id_ballroom=<?php echo $data['id_ballroom'];?>" onclick="return confirm('Hapus data? Data yang telah dihapus tidak bisa dipulihkan');">Hapus</a>
		</td>
	</tr>
<?php
$no++;
